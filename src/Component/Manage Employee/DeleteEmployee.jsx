    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const response = await userService.deleteUser(employeeId); // Call the delete API using useService
          if (response.success) {
            // toast.success("Employee deleted successfully!");
            setSubordinates((prev) =>
              prev.filter((employee) => employee.employee_Id !== employeeId)
            );
                            ...
                            <td>
                              ...
                              >
                                ...
                                >
                                  <path
                                    fill="#ff0000"
                                    d="M135.2 512c-15.9 0-30-11.6-31.7-27.4L65.2 128H16C7.2 128 0 120.8 0 112V80c0-17.7 14.3-32 32-32h112l12.6-25.3C162.3 7.8 176.8 0 192.5 0h63c15.7 0 30.2 7.8 37.8 22.7L306 48h112c17.7 0 32 14.3 32 32v32c0 8.8-7.2 16-16 16h-49.2l-38.3 356.6c-1.7 15.8-15.8 27.4-31.7 27.4H135.2zM416 96H32v16h384V96zm-71.2 32H103.2l34.8 320h212.2l34.8-320zM192 192c13.3 0 24 10.7 24 24v192c0 13.3-10.7 24-24 24s-24-10.7-24-24V216c0-13.3 10.7-24 24-24zm128 0c13.3 0 24 10.7 24 24v192c0 13.3-10.7 24-24 24s-24-10.7-24-24V216c0-13.3 10.7-24 24-24z"
                                  />
                                </svg>
                              </span>
                            </td>
