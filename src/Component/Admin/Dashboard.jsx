...
import AllEmployees from "./AllEmpoloyees";
import UserProfile from "../employee/UserProfile";
import EmployeeDetail from "../employee/EmployeeDetail";
import EditProfile from "../employee/EditProfile";
import ViewLeave from "./ViewLeave";
import ApplyLeaves from "../employee/ApplyLeaves";
import FetchLeave from "../employee/FetchLeave";
import ViewTask from "./ViewTask";
import TaskDetail from "./TaskDetail";
import EmployeeDashboard from "../employee/EmployeeDashboard";
import UpdateTask from "../employee/UpdateTask";
import MyAttendance from "../employee/MyAttendance";
import AllEmployeesHR from "../Manager/AllEmployeesHR";
import AddEMployeesHR from "../Manager/AddEmployeesHR";
import ViewLeaveHR from "../Manager/ViewLeaveHR";
import ViewTaskHR from "../Manager/ViewTaskHR";
import ViewTaskEmployee from "../employee/ViewTaskEmployee";
import ViewPreviousAnnouncements from "../employee/ViewPreviousAnnouncements";
import HRDashboard from "../Manager/HRDashboard";
import MakeAnnouncement from "./MakeAnnouncement";
import { Link } from "react-router-dom";
import ViewPreviousAnnouncementsHR from "../Manager/ViewPreviousAnnouncementsHR";
import service from "../../services/Service";
import axios from "axios";
import Swal from "sweetalert2";
import Help from "./Help";
import GetSupportEmp from "./components/Issue/GetSupportEmp";
import PreviousIssuesEmp from "./components/Issue/PreviousIssuesEmp";
import IssueSystemManager from "../Manager/IssueSystemManager";
import IssueSystemAdmin from "./components/Issue/IssueSystemAdmin";
import ActionTrackerEmployee from "../employee/ActionTrackerEmployee";
import ActionTrackerManager from "../Manager/ActionTrackerManager";
import ShowTaskAssignedManager from "../Manager/ShowTaskAssignedManager";
import ShowReviewsManager from "../Manager/ShowReviewsManager";
import ActionTrackerAdmin from "../Admin/ActionTrackerAdmin";
import ShowTaskAssignedAdmin from "./ShowTaskAssignedAdmin";
import ShowReviewsAdmin from "./ShowReviewsAdmin";
import SuperAdmin from "../superAdmin/SuperAdmin";
import TrainingMaterial from "../employee/TrainingMaterial";
import AdminNotification from "../Notification/AdminNotification";
import ManagerNotification from "../Notification/ManagerNotification";
import EmployeeNotification from "../Notification/EmployeeNotification";
import JobPosting from "./JobPosting";
import DepartmentDesignation from "../superAdmin/DepartmentDesignation";
import DepartmentDetails from "../superAdmin/DepartmentDetails";
import AddManagerSuper from "../superAdmin/AddManagerSuper";
import AddEmployeeSuper from "../superAdmin/AddEmployeeSuper";
import EmployeeDetailSuper from "../superAdmin/EmployeeDetailSuper";
import EmpEditProfile from "../employee/EmpEditProfile";
import ManageDepartment from "./ManageDepartment";
import ManageDepartmentDetail from "./ManageDepartmentDetail";
import BreadCrumb from "./BreadCrumb";
import AdminAdder from "./AdminAdder";
import Hello from "./Hello";
import RACI2 from "./RACI2";
import KpiManager from "../kpi/KpiManager";
import ActionTrackerManager2 from "../Manager/ActionTrackerManager2";
import HRJobFetching from "./HRJobFetching";
import SuperAdminDashboard from "../superAdmin/SuperAdminDashboard";
import EditAnnouncement from "./EditAnnouncement";
import JobFetchSuper from "../superAdmin/JobFetchSuper";
import IssueManagementSuper from "../superAdmin/IssueManagementSuper";
import CompanySettings from "../superAdmin/CompanySettings";
import Payroll from "./Payroll";
import Dashboard1 from "./components/Dashboard1";
import PolicySystemSuper from "../superAdmin/PolicySystemSuper";
import PolicyGetter from "./PolicyGetter";

import InductionPPTViewer from "./InductionPPTViewer";
import PostInduction from "./PostInduction";
import EmployeeJobFetcher from "../employee/EmployeeJobFetcher";
...
import ManagerDashboard from "../Apply leaves/ManagerDashboard";
import LeaveEmployeeDashboard from "../Apply leaves/LeaveEmployeeDashboard";
import PendingLeaveRequests from "../Apply leaves/PendingLeaveRequests";
import EmployeeLeaveHistory from "../Apply leaves/EmployeeLeaveHistory";
import AttendanceView from "./components/AttendanceView/AttendanceView";
import SubordinatesList from "./components/AttendanceView/SubordinateAttendanceView";
import AllIssues from "./components/Issue/AllIssues ";
import EmployeeList from "../superAdmin/EmployeeList";
import EditEmployeePage from "../superAdmin/EditEmployeePage";
import ViewEmployeeDetails from "../superAdmin/ViewEmployeeDetails";
import AddEmployee from "../Manage Employee/AddEmployee";
import UpdateEmployee from "../Manage Employee/UpdateEmployee";
import DeleteEmployee from "../Manage Employee/DeleteEmployee";
import ViewEmployee from "../Manage Employee/ViewEmployee";
import ActiveInactiveEmployee from "../Manage Employee/ActiveInactiveEmployee";
import OrganizationChart from "../Manage Employee/OrganizationChart";
import RatingManager from "../kpi/RatingManager";
import SubordinateRatings from "../kpi/SubordinateRatings";
import EmployeeRatings from "../kpi/EmployeeRatings";
import AllEmployeeRatings from "../kpi/AllEmployeeRatings";
import TopRatedEmployees from "../kpi/TopRatedEmployees";
import ViewTopPerformers from "../kpi/ViewTopPerformers";
import CompanyInfo from "./CompanyInfo";
import AddManagerSuperV2 from "../superAdmin/AddManagerSuperV2";
import EditEmployeePagev2 from "../employee/EditProfilev2";
import UpdateEmployeev2 from "../Manage Employee/UpdateEmployeev2";
import AddDesignationV2 from "./components/Designation/AddDesignationV2";
import Notifications from "../Notification New/Notifications";

const DashboardContent = () => {
  const [isPopupVisible, setIsPopupVisible] = useState(false);
  // Add this at the beginning with other useState hooks
  ...
  // Add this along with your existing useState hooks
  ...
  const [birthdayAnnouncementSent, setBirthdayAnnouncementSent] =
    useState(false);
  // Add this function inside the DashboardContent component
  // Add this function inside the DashboardContent component
  ...
  // Existing functions and useEffect hooks...
  ...
  useEffect(() => {
    getPerformers(selectedMonth, selectedYear);
  }, [selectedMonth, selectedYear]);

  const getPerformers = async (month, year) => {
    try {
      const response = await service.fetchPerformerList(month, year);
      if (response.data.length === 0) {
        setPerformers([]); // Clear the performers list if no performers found
      } else {
        setPerformers(response.data);
      }
    } catch (error) {
      setPerformers([]); // Clear the performers list in case of an error
      ...
      <section className="ems-content">
        <div className="container">
          ...
          <div className="row mt-3 mt-lg-4">
            ...
            {isPerformerPopupVisible && selectedPerformer && (
              <div className="hcm-razr-admin-performer">
                <div className="performer-popup-hcm">
                  <div className="performer-content">
                    <h2>{selectedPerformer.fullName}</h2>
                    <img
                      src={
                        selectedPerformer.img ||
                        "https://via.placeholder.com/150" // Default image if img is null
                      }
                      alt={selectedPerformer.fullName}
                    />
                    <p>{selectedPerformer.description}</p>
                    <p>Department: {selectedPerformer.department}</p>
                    <p>Team: {selectedPerformer.team}</p>
            ...
            <div className="col-lg-6 col-xl-6 col-md-6 mt-4">
              <div className="widget-box">
                <div className="widget-header d-flex justify-content-between align-items-center">
...
const Dashboard = () => {
  return (
    ...
    <Routes>
      ...
      <Route
        path="/all-employees/:department/:teamName/addUser"
        element={<AdminDashboard />}
      />
      {/* <Route path="/all-employees" element={<ManageDepartment />} /> */}
      <Route path="/manager-dashboard" element={<HRDashboard />} />
      <Route path="/view-task" element={<ViewTask />} />
      <Route path="/assign-task" element={<AssignTask />} />
      <Route path="/employee-dashboard" element={<EmployeeDashboard />} />
      <Route path="/my-profile" element={<MyProfile />} />
      <Route path="/fetch-leaves" element={<ApplyLeaves1 />} />
      ...
      <Route path="/updatev2/:id" element={<EditEmployeePagev2 />} />
      <Route path="/apply-leaves" element={<ApplyLeaves1 />} />
      {/* <Route path="/manager/leaverequests" element={<ManagerLeaveRequests />} /> */}
      <Route path="/leavemanage" element={<LeaveEmployeeDashboard />} />
      <Route path="/leavemanager" element={<ManagerDashboard />} />
      {/* <Route path="/pendingleaverequests" element={<PendingLeaveRequests />} /> */}
      <Route path="/employeeleavehistory" element={<EmployeeLeaveHistory />} />
      <Route path="/subordinateslist" element={<SubordinatesList />} />
      <Route
        path="/employee-attendance/:employeeId"
        element={<AttendanceView />}
      />
      <Route path="/view-leave" element={<ViewLeaveAdmin />} />
      <Route path="/view-leave-manager" element={<ViewLeaveAdmin />} />
      <Route path="/view-task" element={<ViewTask />} />
      <Route path="/view-task/task-detail" element={<TaskDetail />} />
      <Route path="/update-task" element={<ViewTaskEmployee />} />
      <Route path="/add-task" element={<UpdateTask />} />
      <Route path="/my-attendance" element={<MyAttendance />} />
      <Route path="/all-employees-hr" element={<AllEmployeesHR />} />
      <Route path="/add-user-hr" element={<AddEMployeesHR />} />
      <Route path="/view-leave-hr" element={<ViewLeaveHR />} />
      <Route path="/view-task-hr" element={<ViewTaskHR />} />
      <Route path="/view-task-hr" element={<HRDashboard />} />
      <Route path="/add-announcement" element={<MakeAnnouncement />} />
      <Route path="/support" element={<Help />} />
      <Route path="/raci" element={<Hello />} />
      <Route path="/raci2" element={<Dashboard1 />} />
      <Route path="/admin-raci2" element={<Dashboard1 />} />
      <Route
        path="/view-previous-announcements"
        element={<ViewPreviousAnnouncements />}
      />
      <Route
        path="/view-previous-announcements-hr"
        element={<ViewPreviousAnnouncementsHR />}
      />
      {/* ----------------------EMPLOYEE------------------------ */}
      <Route path="/get-support" element={<GetSupportEmp />} />
      <Route path="/employee-pending-jobs" element={<EmployeeJobFetcher />} />
      <Route
        path="/get-support/previous-issues"
        element={<PreviousIssuesEmp />}
      />
      <Route path="/action-tracker" element={<ActionTrackerEmployee />} />
      <Route path="/training-material" element={<TrainingMaterial />} />
      <Route
        path="/my-profile/employee-edit-profile"
        element={<EmpEditProfile />}
      />
      {/* ----------------------MANAGER------------------------ */}
      <Route path="/manage-issues-manager" element={<IssueSystemManager />} />
      <Route
        path="/manager-action-tracker"
        element={<ActionTrackerManager />}
      />
      <Route
        path="/manager-action-tracker2"
        element={<ActionTrackerManager2 />}
      />
      <Route
        path="/manager-action-tracker/task-assigned-manager"
        element={<ShowTaskAssignedManager />}
      />
      <Route
        path="/manager-action-tracker/review"
        element={<ShowReviewsManager />}
      />
      {/* ----------------------ADMIN------------------------ */}
      <Route path="/make-announcement/:id" element={<EditAnnouncement />} />
      <Route path="/manage-issues-admin" element={<IssueSystemAdmin />} />
      <Route path="/admin-action-tracker" element={<ActionTrackerAdmin />} />
      <Route path="/admin-action-tracker2" element={<KpiManager />} />
      <Route path="/kpi-rating" element={<RatingManager />} />
      <Route path="/subordinate-rating" element={<SubordinateRatings />} />
      <Route
        path="/employee/ratings/:employeeId"
        element={<EmployeeRatings />}
      />
      <Route path="/all/employee/ratings" element={<AllEmployeeRatings />} />
      <Route path="/topratedemployees" element={<TopRatedEmployees />} />
      <Route path="/topperformanceemployees" element={<ViewTopPerformers />} />

      <Route
        path="/admin-action-tracker/task-assigned-admin"
        element={<ShowTaskAssignedAdmin />}
      />
      <Route
        path="/admin-action-tracker/review"
        element={<ShowReviewsAdmin />}
      />
      <Route
        path="/admin-action-tracker/review"
        element={<ShowReviewsAdmin />}
      />
      {/* <Route path="/add-user" element={<AdminAdder />} /> */}
      ...
      <Route path="/job-fetching" element={<HRJobFetching />} />
      <Route path="/departdesig" element={<DepartmentDesignation />} />
      <Route path="/department-details" element={<DepartmentDetails />} />
      <Route
        path="/all-employees/:department"
        element={<ManageDepartmentDetail />}
      />
      <Route path="/payroll" element={<Payroll />} />
      <Route
        path="/all-employees/:department/:teamName"
      ...
      <Route path="/add-manager-super" element={<AddManagerSuper />} />
      <Route path="/allemployes" element={<EmployeeList />} />
      <Route path="/allemployes/edit/:id" element={<EditEmployeePage />} />
      <Route path="/allemployes/view/:id" element={<ViewEmployeeDetails />} />
      <Route path="/super-admin-add-employee" element={<AddEmployeeSuper />} />
      <Route
        path="/super-admin-employee-detail"
        element={<EmployeeDetailSuper />}
      />
      <Route
        path="/super-admin-employee-detail"
        element={<EmployeeDetailSuper />}
      ...
      <Route path="/super-job-vacancies" element={<JobFetchSuper />} />
      <Route
        path="/issue-management-super"
        element={<IssueManagementSuper />}
      />
      <Route path="/update-policies" element={<PolicySystemSuper />} />
      <Route path="/policies" element={<PolicyGetter />} />
      <Route path="/post-induction" element={<PostInduction />} />
      <Route path="/induction" element={<InductionPPTViewer />} />
      <Route path="/all-issues" element={<AllIssues />} />
      {/* <Route path="/add-designation" element={<AddDesignation />} /> */}
      {/* -----------------add designation------------------------ */}
      <Route path="/addDesignation" element={<AddDesignationV2 />} />
      <Route path="/designations" element={<DesignationList />} />
      {/* ----------------------Manage Employeee------------------------ */}
      <Route path="/add-employee" element={<AddEmployee />} />
      <Route path="/add-employeev2" element={<AddManagerSuperV2 />} />
      <Route path="/update-employee" element={<UpdateEmployee />} />
      <Route path="/update-employeev2" element={<UpdateEmployeev2 />} />
      <Route path="/delete-employee" element={<DeleteEmployee />} />
      <Route path="/all-employees" element={<ViewEmployee />} />
      <Route
        path="/active-inactive-employee"
        element={<ActiveInactiveEmployee />}
      />
      <Route path="/organization-chart" element={<OrganizationChart />} />
      <Route path="/notificationv2" element={<Notifications/>} />
    </Routes>
    // </LayoutWrapper>
  );
};
