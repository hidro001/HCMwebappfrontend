  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      try {
        const accessToken = localStorage.getItem("accessToken");
        const response = await axios.get(
          `https://apiv2.humanmaximizer.com/api/v1/mstats/managersstats/${userId}`,
          {
            headers: {
              Authorization: `Bearer ${accessToken}`,
            },
        ...
        console.log("manager responce", response);

        if (response.data.success) {
          setTotalUsers(response.data.totalSubordinates);
          setUsersLoggedInToday(
            response.data.numberOfSubordinatesLoggedInToday
          );
          setEmployeesOnLeaveToday(
            response.data.numberOfSubordinatesOnLeaveToday
          );
        ...
        <div className="container">
          <div className="hm-dash-head-cards-container">
            <div className="hm-dash-head-cards-row">
              ...
              {/* <div className="employees-per-department mt-4">
