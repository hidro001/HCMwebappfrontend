...
//         <p><strong>Department:</strong> {employee.departmentAlocated}</p>
//         <p><strong>Role:</strong> {employee.user_Role}</p>
//         <p><strong>Email:</strong> {employee.working_Email_Id}</p>
//         <p><strong>Mobile:</strong> {employee.mobile_No}</p>
//         <p><strong>Date of Joining:</strong> {employee.date_of_Joining}</p>
//         <p><strong>Salary:</strong> {employee.salary}</p>
//         <p><strong>Address:</strong> {employee.office_Address}</p>
//       </div>
//     </div>
//   );
// };
...
const ViewEmployeeDetails = () => {
  ...
  return (
    <div className="main">
      <div className="ems-content rzr-emp-details-super">
        <motion.div
          className="container"
          ...
          <div className="card shadow-lg p-4">
            ...
            >
              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  ...
                  <p>
                    <strong>Address:</strong> {employeeData.user_Address}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="d-flex justify-content-end mt-4">
              <motion.button
                ...
                whileHover={{ scale: 1.1 }}
                onClick={() =>
                  navigate(`/dashboard/allemployes/edit/${employeeData._id}`)
                }
              >
