...
import DocumentField from "./DocumentField"; // Ensure this component exists
    ...
    documents:
      employeeData?.documents?.length > 0
        ? employeeData.documents.map((doc) => ({
            ...
            preview: null, // Placeholder for file preview
          }))
        : [
            {
              name: "",
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (response.data.success) {
            ...
            navigate("/dashboard/allemployes"); // Navigate back to the employee list
            resetForm();
          } else {
            toast.error(
              ...
              <Form encType="multipart/form-data">
                ...
                <div className="alert alert-info d-flex justify-content-between align-items-center">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      navigate("/dashboard/allemployes"); // Navigate back without saving
