...
//   // ----- Add a new KPI -----
//   addKpi: async (name, weight) => {
//     // Basic client-side validation
//     if (!name.trim() || weight < 0 || weight > 100) {
//       toast.error("Please provide a valid name and weight (0-100).");
//       return;
//     }

//     const { kpis, selectedDesignation } = get();

//     // Check total weight not exceeding 100%
//     const totalWeight = kpis.reduce((acc, k) => acc + k.weight, 0) + weight;
//     if (totalWeight > 100) {
...
//   updateKpi: async (id, name, weight) => {
//     // Validate
//     if (!name.trim() || weight < 0 || weight > 100) {
//       toast.error("Please provide a valid name and weight (0-100).");
//       return;
...
//     // Find the oldKPI and check total weights
...
//     // Exclude oldKpi weight from the sum, then add the new weight
//     const totalWeight =
//       kpis.reduce((acc, k) => (k._id === id ? acc : acc + k.weight), 0) + weight;
//     if (totalWeight > 100) {
//       toast.error("Total weight exceeds 100%. Please adjust the KPI weights.");
//       return;
//     }
