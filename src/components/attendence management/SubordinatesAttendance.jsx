...
//                           />
//                         ) : (
//                           <div className="w-8 h-8 rounded-full mr-2 flex items-center justify-center bg-gray-200 text-gray-500">
//                             👤
//                           </div>
//                         )}
//                         <span>{emp.name}</span>
...
export default function SubordinatesAttendance() {
  ...
  // -- Set default month to the current month/year. If you want strictly "Feb 2025",
  // replace this logic with: const defaultMonth = "2025-02";
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 dark:text-gray-100 p-6">
      ...
      >
        ...
        {/* Example card: Total In Late (Adjust if your API has different fields) */}
        <div className="rounded-md p-4 flex items-center justify-between bg-white dark:bg-gray-800 shadow">
          <div>
            <h2 className="text-sm font-medium mb-1">Total In Late</h2>
            <p className="text-2xl font-semibold">
