...
//       id: editId,
//       name: sysName,
//       workingDays,      // or array if needed
...
//                 {/* if ls.workingDays is an array, you'd do ls.workingDays.join(', ') */}
...
import { FaEdit, FaTrash } from "react-icons/fa";
import useCompanySettingsStore from "../../../store/useCompanySettingsStore";
import LeaveSystemModal from "./models/LeaveSystemModal"; // Adjust the path as needed
...
const LeaveSystems = () => {
  ...
  const handleSave = () => {
    ...
    const payload = {
      id: editId,
      name: sysName,
      workingDays, // (or convert to an array if needed)
      monthlyPaidLeaves: monthlyLeaves,
    };
    addOrUpdateLeaveSystem(payload);
