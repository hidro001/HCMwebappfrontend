...
//               <td className="p-2 text-gray-700 dark:text-gray-200">{hol.name}</td>
//               <td className="p-2 text-gray-700 dark:text-gray-200">{hol.date}</td>
//               <td className="p-2 text-gray-700 dark:text-gray-200">{hol.recurring}</td>
