...
export default function LeavePolicies() {
  ...
  const inputFields = [
    ...
    },
    {
     ...
     condition: (policies) => (policies.carryForwardAllowed === true || (policies.carryForwardResetDayMonth && policies.carryForwardResetDayMonth.length > 0)),
    }
  ];
                ...
                {inputFields
                  ...
                  .map((field) => (
                    ...
                    >
                      ...
                      {field.type === "boolean" && (
                        <select
                          value={localPolicies.carryForwardResetDayMonth?.length > 0 ? "Yes" : "No"}
                          onChange={(e) => {
                      ...
                      {field.type === "dayMonth" && localPolicies.carryForwardResetDayMonth?.length > 0 && (
                        <div className="flex gap-4">
                          ...
                          <select
                            value={localPolicies[field.name]?.split("-")[1] || "01"}
                            onChange={(e) => {
                      ...
                      {field.type !== "select" && field.type !== "boolean" && field.type !== "dayMonth" && (
                        <input
                          type={field.type}
                          value={localPolicies[field.name] ?? ""}
                          onChange={(e) => handleChange(field.name, e.target.value)}
