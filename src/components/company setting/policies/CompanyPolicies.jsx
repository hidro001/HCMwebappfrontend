...
// src/components/CompanyPolicies.js
...
// const TABS = ["All", "Attendance", "Sales", "HR", "IT"];
...
//   // UI state for modal, tab selection, and confirmation dialog
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [selectedTab, setSelectedTab] = useState("All");
//   const [confirmDialogOpen, setConfirmDialogOpen] = useState(false);

//   // Use the Zustand store
//   const { policies, fetchPolicies, createPolicy, loading } = usePolicyStore();
...
//   const handleCancelUpload = () => setConfirmDialogOpen(false);

//   // When the user clicks "Upload Policy" in the modal, show the confirmation dialog
//   const onUploadClick = () => setConfirmDialogOpen(true);
...
//         policyNumber={policyNumber}
//         setPolicyNumber={setPolicyNumber}
//         handleUpload={onUploadClick} // Show confirmation before uploading
//       />
...
//         message="Are you sure you want to upload this policy?"
...
// import ConfirmationDialog from "../../common/ConfirmationDialog";
// import usePolicyStore from "../../../store/usePolicyStore";
// import useCategoryStore from "../../../store/useCategoryStore"; // New: for dynamic categories
// import CategoryManagementModal from "./model/CategoryManagementModal"; // New: modal for managing categories
...
//   // UI state for modals, tab selection, and confirmation dialog
//   const [isModalOpen, setIsModalOpen] = useState(false);
...
//   // UI state for modals, tab selection, and confirmation dialogs
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [isCategoryModalOpen, setIsCategoryModalOpen] = useState(false);
//   const [selectedTab, setSelectedTab] = useState("All");
//   const [confirmDialogOpen, setConfirmDialogOpen] = useState(false);
...
//   // Confirmation dialog handlers for upload
//   const handleConfirmUpload = () => {
//     setConfirmDialogOpen(false);
//     handlePolicyUpload();
//   };
