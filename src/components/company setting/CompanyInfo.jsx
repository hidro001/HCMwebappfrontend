...
//                                         <span className="font-medium text-blue-600 dark:text-blue-400">Lat:</span>
//                                         <span className="ml-1 text-gray-700 dark:text-gray-300">
//                                           {office.latitude || "—"}
//                                         </span>
//                                       </div>
//                                       <div className="bg-green-50 dark:bg-green-900/20 p-2 rounded">
//                                         <span className="font-medium text-green-600 dark:text-green-400">Lng:</span>
//                                         <span className="ml-1 text-gray-700 dark:text-gray-300">
//                                           {office.longitude || "—"}
//                                         </span>
//                                       </div>
  ...
  return (
    <>
      ...
      <motion.div
        ...
        animate="visible"
        variants={containerVariants}
        className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950 p-4 md:p-6 lg:p-8"
      >
        <div className="max-w-7xl mx-auto space-y-8">
          {/* Header Section */}
          <motion.div
          ...
          >
            <div className="flex items-center justify-center space-x-3">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400">
                Company Management
              </h1>
            </div>
            <p className="text-gray-600 dark:text-gray-400 text-lg">
          ...
          >
            <div
              className="p-6 bg-blue-600 cursor-pointer"
              onClick={() => setIsFormExpanded(!isFormExpanded)}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                      ...
                      <AnimatePresence>
                        {fields.map((item, index) => (
                          <motion.div
                            ...
                            exit={{ opacity: 0, y: -20 }}
                            transition={{ duration: 0.3 }}
                            className="relative bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-600"
                          >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                              <div className="space-y-2">
                                <label className="flex items-center space-x-2 font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        type="submit"
                        className="flex items-center justify-center space-x-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
                      >
                        <FaSave />
                        <span>{editingCompany ? "Update Company" : "Save Company"}</span>
                      </motion.button>
