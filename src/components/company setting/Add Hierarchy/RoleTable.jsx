...
//           <tbody>
//             {isLoading ? (
//               <SkeletonRows count={10} columns={4} />
//             ) : (
//               data.map((role, idx) => (
...
//                     <button className="text-blue-500 hover:text-blue-600" title="View">
//                       <FaEye />
//                     </button>
...
// // Provided permissions list (or import from another file)
...
//   // Toggle a permission in the selectedPermissions array
...
//     // For demo, just log the new role data
//     console.log("New Role Name:", roleName);
//     console.log("Permissions:", selectedPermissions);

//     // Typically you'd POST to your API here
//     // e.g., await api.createRole({ roleName, permissions: selectedPermissions });
...
//             {/* Modal Title */}
//             <h2 className="text-lg font-semibold mb-4">Add New Roles</h2>
