...
// src/components/model/BreakSettingsModal.jsx
import React from 'react';
import { motion } from 'framer-motion';
import { FiX } from 'react-icons/fi';
import BaseModal from '../../../common/BaseModal';
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose}>
      ...
      >
        ...
        <form onSubmit={onSubmit}>
          {/* Input for Break Type */}
          <div className="mb-4">
            <label htmlFor="breakType" className="block text-gray-700 dark:text-gray-200 mb-1">
              Break Type
            </label>
            <input
              id="breakType"
          ...
          {/* Input for Break Duration (Hours) */}
          <div className="mb-4">
            <label htmlFor="breakDuration" className="block text-gray-700 dark:text-gray-200 mb-1">
              Break Duration (Hours)
            </label>
            <input
              id="breakDuration"
          ...
          {/* Input for Auto Break Start (Minutes) */}
          <div className="mb-4">
            <label htmlFor="autoBreakStart" className="block text-gray-700 dark:text-gray-200 mb-1">
              Auto Break Start (Min)
            </label>
            <input
              id="autoBreakStart"
          ...
          {/* Radio buttons for Detection Type */}
          <div className="mb-4">
            <label className="block text-gray-700 dark:text-gray-200 mb-1">Detection Type</label>
            <div className="flex items-center space-x-4">
              <label className="inline-flex items-center text-gray-700 dark:text-gray-200">
                <input
                  type="radio"
