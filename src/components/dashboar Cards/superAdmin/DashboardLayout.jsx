...
function DashboardLayout() {
  return (
    <div className="flex w-full flex-col bg-white dark:bg-[#121212] p-3.5">
      ...
      <div class="grid grid-cols-5 grid-rows-12 gap-4">
        ...
        <div class="col-span-2 row-span-3 col-start-4">2</div>
        <div class="col-span-3 row-span-2 col-start-1 row-start-2">
          {" "}
          <div className="flex w-full flex-col gap-5 md:flex-row">
            <EmployeeStatusChart />
            <DepartmentChart />
        ...
        <div class="col-span-3 row-span-3 col-start-1 row-start-4">4</div>
        <div class="col-span-2 row-span-3 col-start-4 row-start-4">5</div>
        <div class="col-span-3 row-span-3 col-start-1 row-start-7">6</div>
        <div class="col-span-3 row-span-3 col-start-1 row-start-10">7</div>
        <div class="col-span-2 row-span-6 col-start-4 row-start-7">8</div>
      </div>
    </div>
  );
}
