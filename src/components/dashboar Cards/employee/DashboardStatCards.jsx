...
//         {/* Hover Indicator for Full Card Click */}
//         <AnimatePresence>
//           {interactive && isHovered && (
//             <motion.div 
...
//             >
//               <motion.div
//                 className={`flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r ${gradient} text-white text-xs font-medium shadow-lg`}
//                 animate={{ x: [0, 4, 0] }}
//                 transition={{ duration: 1, repeat: Infinity }}
//               >
