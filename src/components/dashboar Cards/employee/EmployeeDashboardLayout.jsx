...
//         {/* Top Row - Stats Overview & Attendance */}
...
//           {/* Attendance Card - Right Side */}
//           <motion.section 
//             className="lg:col-span-4 bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/30 overflow-hidden"
//             variants={cardVariants}
//             whileHover="hover"
//             {...hoverVariants}
//           >
...
//   return (
//     <motion.div
//       className="min-h-screen w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 border"
//       variants={containerVariants}
//       initial="hidden"
//       animate="visible"
//     >
...
//       {/* Main Dashboard Content */}
//       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border">
        
//         {/* Top Row - Stats Overview & Attendance */}
//         <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6 border">
//           {/* Stats Overview - Left Side */}
//           <motion.section 
//             className="lg:col-span-8"
//             variants={cardVariants}
