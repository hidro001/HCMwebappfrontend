  ...
  return (
    <div className="flex flex-col items-center px-4 pt-5 pb-12 w-full text-xs bg-white rounded-2xl shadow-lg text-slate-500 max-md:pr-5 max-md:max-w-full">
      <div className="flex flex-wrap gap-5 justify-between max-w-full text-lg font-semibold text-lime-600 w-[817px]">
        ...
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/e27481be70d9c22011875fb33866b5de1099d3c8a5fa5d32320f973014bf4d46?placeholderIfAbsent=true&apiKey=20f8535bc9c14cd29ad8328e998bd290"
          alt=""
      ...
      <div className="flex flex-wrap gap-3 mt-16 max-w-full text-right whitespace-nowrap w-[789px] max-md:mt-10">
        ...
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/074006f5-85e3-4ef3-a8d3-299b6e087b94?placeholderIfAbsent=true&apiKey=20f8535bc9c14cd29ad8328e998bd290"
