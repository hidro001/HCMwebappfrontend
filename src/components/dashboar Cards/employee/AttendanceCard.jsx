...
function AttendanceCard() {
  ...
  return (
    <div className="flex overflow-hidden flex-col justify-center self-center px-7 py-6 mt-9 max-w-full bg-white rounded-xl border border-gray-200 border-solid shadow-sm w-[366px] max-md:px-5">
      <div className="flex flex-col w-full">
        <div className="flex gap-9 items-center w-full">
          ...
          <div className="flex relative flex-col self-stretch my-auto rounded-none aspect-[1.41] w-[55px]">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/6fcb942a-a338-4a6f-ae0a-6a9763fc7243?placeholderIfAbsent=true&apiKey=20f8535bc9c14cd29ad8328e998bd290"
              alt=""
        ...
        <div className="flex flex-col self-center mt-5 max-w-full tracking-tighter text-center whitespace-nowrap text-stone-500 w-[180px]">
        ...
        <div className="flex flex-col mt-5 w-full text-xl tracking-tighter leading-10 text-stone-500">
          Continuing from the AttendanceCard.jsx file:

          {attendanceStats.map((stat, index) => (
            <div key={index} className="flex gap-10 justify-between items-center w-full">
              <div className="self-stretch my-auto font-medium">{stat.label}</div>
