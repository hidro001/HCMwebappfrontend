...
export default function FNFApproval() {
  ...
  const checkTableOverflow = () => {
    ...
    if (tableRef.current) {
      ...
      setShowViewToggle(!isOverflowing); // Show toggle only when table fits
    }
  };

  useEffect(() => {
    // Check overflow after data loads and when tab changes
  ...
  const shouldShowCards = () => {
    ...
    // Auto mode: show cards if overflowing
