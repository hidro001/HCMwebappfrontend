                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg text-sm space-y-2">
                    ...
                    <p><strong>Resignation Date:</strong> {selectedResignation.resignationDate
                      ...
                      : "N/A"}</p>
                    <p><strong>Last Working Day:</strong> {selectedResignation.lastWorkingDay
                  ...
                  {selectedResignation && (
                    <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                          <span className="font-medium">Last Working Day:</span> {selectedResignation.lastWorkingDay
                            ? new Date(selectedResignation.lastWorkingDay).toLocaleDateString()
                            : "N/A"}
                        </p>
                      </div>
