...
//           <motion.div
//             className="relative z-10 w-full max-w-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl p-4 mx-4 my-8 transition-colors"
...
//                   <div
//                     key={cmt._id || idx}
//                     className="bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md p-3 shadow-sm"
//                   >
...
//             <div className="mt-4">
//               <textarea
//                 className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 rounded p-2 text-sm text-gray-800 dark:text-gray-100 focus:outline-none placeholder-gray-400 dark:placeholder-gray-500"
//                 rows={3}
...
//                   className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm shadow-md transition-colors"
//                 >
//                   Post
//                 </button>
//               </div>
