...
//                       <select
//                         className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all w-full appearance-none"
//                         value={sortOrder}
//                         onChange={(e) => {
//                           setSortOrder(e.target.value);
//                           setCurrentPage(1);
...
//                 <FaClipboardList className="text-4xl text-gray-400 dark:text-gray-500" />
//               </div>
...
//                     <BiSort className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
//                     <select
//                       className="pl-10 pr-4 py-2 border border-gray-600 rounded-lg text-sm bg-gray-700 text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all w-full appearance-none"
//                       value={sortOrder}
//                       onChange={(e) => {
//                         setSortOrder(e.target.value);
//                         setCurrentPage(1);
...
//                 <FaClipboardList className="text-4xl text-gray-500" />
//               </div>
