      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            exit={{ y: 30 }}
          >
            <div className="pointer-events-auto flex flex-1 bg-white/5 dark:bg-gray-800 backdrop-blur-md border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-lg overflow-hidden shadow-lg">
