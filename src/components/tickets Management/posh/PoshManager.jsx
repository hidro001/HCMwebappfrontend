...
//   useEffect(() => {
//     fetchPoshActs().then(() => tableControls.start("visible"));
//   }, [fetchPoshActs, tableControls]);
...
//                   >
//                     <td className="p-3 text-sm">{String(slIndex).padStart(2, "0")}</td>
//                     <td className="p-3 text-sm text-blue-600 dark:text-blue-400">{ticket.reporterId}</td>
//                     <td className="p-3 text-sm">{ticket.reporterName}</td>
