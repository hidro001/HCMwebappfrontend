...
//   const { poshActs, fetchAllUserPoshActs } = usePoshStore();
...
//         ticket={selectedItem}
//         onSave={(formData) => {
//             // 1) Perform your update in the store, or call an API
//             //    e.g., updatePoshAct(selectedItem.id, formData)
        
//             // 2) Then optionally refetch or refresh your data
//             //    fetchAllUserPoshActs();
...
//   useEffect(() => {
//     fetchAllUserPoshActs().then(() => tableControls.start("visible"));
//   }, [fetchAllUserPoshActs, tableControls]);
...
//                   >
//                     <td className="p-3 text-sm">{String(slIndex).padStart(2, "0")}</td>
//                     <td className="p-3 text-sm text-blue-600 dark:text-blue-400">{ticket.type}</td>
//                     <td className="p-3 text-sm text-blue-600 dark:text-blue-400">{ticket.accusedId}</td>
//                     <td className="p-3 text-sm">{ticket.accusedName}</td>
//                     <td className="p-3 text-sm">
//                       {ticket.incidentDate
//                         ? new Date(ticket.incidentDate).toLocaleDateString("en-GB", {
...
//   // Additional variants for the table and its rows
//   const tableContainerVariants = {
//     hidden: { opacity: 0 },
//     visible: {
//       opacity: 1,
...
//       opacity: 1,
//       transition: {
//         duration: 0.2,      // Controls how fast the container fades in
//         when: "beforeChildren",
//         staggerChildren: 0.05,
//       },
...
//       y: 0,
//       transition: {
//         duration: 0.1, // Controls how fast each row animates in
//         ease: "easeOut",
//       },
//     },
//   };
