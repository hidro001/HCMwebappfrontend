...
const PassportValidityCard = () => {
  ...
  const { completeCount, pendingCount, completePercentage, pendingPercentage } =
    data;
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        <div className="flex items-center gap-3">
          <div
            className="p-2 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 
          ...
          <div>
            <h2
              className="font-bold text-lg sm:text-xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            >
              <div
                className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-emerald-600 to-blue-600 
      ...
      <DetailModal
        ...
        rows={drill.rows}
        title="Valid Passport – User List"
      />
    </motion.div>
  );
};
