...
const WorkplaceHotspotsChart = () => {
  ...
  const { data, loading, error, fetchDepartmentStats } =
    useDepartmentIssueStatsStore();
  ...
  return (
    <div
      className="max-w-4xl mx-auto p-4 bg-white dark:bg-slate-800 
        rounded-md shadow-sm text-gray-900 dark:text-gray-100"
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
        <h2 className="text-lg font-semibold">
          Ensuring 100% Compliance in Regulated Roles
        </h2>
