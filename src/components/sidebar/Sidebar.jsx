...
//   // Updated: We remove the old "sub-sidebar" logic
//   // and simply notify the parent when a user clicks
//   // an icon. The parent will then render horizontal tabs.

//   const handleSidebarItemClick = (item) => {
//     // Send the entire item (or just item.options) to the parent
...
//   return (
//     <div className="bg-gray-200 dark:bg-gray-800 border-r border-gray-500 w-16 flex flex-col items-center py-4 space-y-6">
//       {filteredMenuItems.map((item, index) => (
//         <button
//           key={index}
...
//   return (
//     <div className="bg-gray-200 dark:bg-gray-800 border-r border-gray-500 w-16 flex flex-col items-center py-4 space-y-6 h-screen overflow-y-auto hide-scrollbar">
//       {filteredMenuItems.map((item, index) => (
//         <button
//           key={index}
//           onClick={() => handleSidebarItemClick(item)}
