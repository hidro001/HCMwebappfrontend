...
//   const canDeleteEmployee = permissions?.includes("deleteEmployeeAdmin");
//   const canToggleStatus = permissions?.includes("active/InactiveEmployeeAdmin");
//   const hasOnlyEmployeeView = permissions?.includes("OnlyEmployeeView");
...
//                       </button>
//                     )}
//                     {!hasOnlyEmployeeView && canDeleteEmployee && (
//                       <button
//                         title="Delete"
//                         className="hover:text-gray-800 dark:hover:text-white"
//                         onClick={() => openDeleteDialog(user.employee_Id)}
...
//                     </div>
//                   </div>
//                   {!hasOnlyEmployeeView && canToggleStatus && (
//                     <div className="mt-4 flex items-center justify-center gap-2">
//                       <label
//                         htmlFor={`toggleSwitch-${user._id}`}
//                         className="text-xs sm:text-sm font-semibold"
...
function SupordinatesEmployess() {
  ...
  const canDeleteEmployee = permissions?.includes("deleteEmployeeAdmin");
  const canToggleStatus = permissions?.includes("active/InactiveEmployeeAdmin");
  const canViewProfile = permissions?.includes("OnlyEmployeeView");
  const canEditEmployee = permissions?.includes("updateEmployeeManager");
