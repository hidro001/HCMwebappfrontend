...
//                       <option value="g1">XYZ</option>
//                       <option value="g2">Some Group</option>
...
//                     >
//                       <option value="">Select</option>
//                       <option value="m1">Model A</option>
//                       <option value="m2">Model B</option>
//                       {/* Add more dynamic options as needed */}
//                     </select>
//                   </div>
...
//                       <label className="flex flex-col items-center px-3 py-2 bg-blue-50 text-blue-600 
...
//                     >
//                       <option value="">Select</option>
//                       <option value="desc1">Description A</option>
//                       <option value="desc2">Description B</option>
//                       {/* Add more dynamic options as needed */}
//                     </select>
//                   </div>
//                 </div>
 ...
 * - onSubmit (function): callback that receives form data
 * - employeeName (string): the employee’s full name (for the header)
 */
export default function AssignAssetModal({
  isOpen,
  onClose,
