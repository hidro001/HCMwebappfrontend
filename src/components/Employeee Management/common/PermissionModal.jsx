...
//         </div>
//         <div className="flex justify-end space-x-3">
//           <button onClick={onClose} className="px-4 py-2 rounded border bg-gray-100 text-gray-700 hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
//             Cancel
//           </button>
//           <button onClick={() => onSave(selectedPerms)} className="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700">
//             Confirm
//           </button>
//         </div>
//       </div>
