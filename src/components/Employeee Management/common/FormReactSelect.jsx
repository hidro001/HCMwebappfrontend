// // src/components/common/FormReactSelect.jsx
...
//   // Optional: detect dark mode if your project uses it
//   const isDarkMode = document.documentElement.classList.contains("dark");

//   // Customize react-select styling
//   const customStyles = {
//     control: (base) => ({
//       ...base,
...
//   // If "required" is part of registerOptions or we have a separate requiredMessage
...
//           ...registerOptions,
//           validate: (value) => {
//             // For multi-select, ensure we have at least one if required
//             if (isMulti && requiredMessage) {
//               if (!value || value.length === 0) {
//                 return requiredMessage;
//               }
//             }
//             // For single-select, ensure we have a value
//             if (!isMulti && requiredMessage) {
//               if (!value) {
//                 return requiredMessage;
//               }
...
//   // Customize react-select styling to handle dark vs. light:
//   const customStyles = {
//     control: (base) => ({
//       ...base,
//       borderColor: errorMsg ? "red" : base.borderColor,
//       backgroundColor: isDarkMode ? "#fafafa" : "#fff", // dark:bg-gray-700
//     }),
//     menu: (base) => ({
//       ...base,
//       backgroundColor: isDarkMode ? "#374151" : "#fff",
...
//   // Handle "required" label indicator:
//   const isRequired = !!registerOptions.required || !!requiredMessage;
...
//           ...registerOptions,
//           validate: (value) => {
//             // For multi-select, ensure we have at least one if it's required:
//             if (isMulti && requiredMessage) {
//               if (!value || value.length === 0) {
//                 return requiredMessage;
//               }
//             }
//             // For single-select, ensure we have a value if it's required:
//             if (!isMulti && requiredMessage) {
//               if (!value) {
//                 return requiredMessage;
//               }
