   ...
   function SetKpis() {
     /* ---------------------------------------------------------------------
        Zustand stores
     --------------------------------------------------------------------- */
     const { designations, loading: designationLoading, fetchDesignations } =
       useDesignationStore();
     const {
       createKpiSet,
       getKpiSet,
     ...
     const handleUpdateKpiSet = async () => {
       if (!kpiSet?._id)
         return toast.error("No KPI set loaded to update (fetch or create first).");
       ...
       const payload = {
         ...
         kpis,
         totalMarks: sum,
         version: version ? Number(version) : kpiSet.version,
         updatedBy: "adminUser",
       };
           ...
           <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg">
             <div className="p-6 flex flex-col">
               ...
               <div className="flex justify-between items-center mb-2">
                 <span className="text-gray-600 dark:text-gray-400">Allocated Marks:</span>
                 <span
               ...
               {kpis.length === 0 ? (
                 <div className="p-12 flex flex-col items-center text-gray-500 dark:text-gray-400">
                   ...
                   <p className="mt-1 text-sm text-center">
                     Add your first KPI using the form above.<br />
         ...
         {kpiError && (
           <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
             <div className="flex items-center">
               ...
               <p className="text-red-700 dark:text-red-400 font-medium">{kpiError}</p>
             </div>
           </div>
         )}
       </div>
