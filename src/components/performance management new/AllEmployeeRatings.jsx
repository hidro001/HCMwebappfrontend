...
// // Frequencies array with icons (similar to your Team component)
// const FREQUENCIES = [
...
//   // ======== STORES & ACTIONS ========
//   const { getOrgRatingsAdvanced, loading, error } = useRatingStore();
//   const {
//     departments,
//     fetchDepartments,
//     loading: deptLoading,
...
//   // ======== LOAD DEPARTMENTS & DESIGNATIONS ONCE ========
//   useEffect(() => {
//     fetchDepartments();
//     fetchDesignations();
...
//         // If current startWeek is invalid, reset to first
...
//         // If current endWeek is invalid, reset
...
//       if (res.success) {
//         setOrgData(res.data); // array of { employee, filteredRatings, averageRating, ratingCount }
...
//                     {orgData.map(({ employee, averageRating, ratingCount }) => (
//                       <tr
//                         key={employee._id}
