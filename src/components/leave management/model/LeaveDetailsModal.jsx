...
// import BaseModal from "../../common/BaseModal"; // Adjust this import path as needed

// export default function LeaveDetailsModal({ leave, onClose }) {
//   // If there's no "leave" selected, don't render anything
...
//         </p>
//         <p>
//           <strong>Reason for Leave:</strong> {leave.reasonForLeave}
//         </p>
//         <p>
//           <strong>Leave Category:</strong> {leave.leaveCategory}
//         </p>
//         <p>
//           <strong>Processed By:</strong> {leave.processedBy}
//         </p>
//         <p>
//           <strong>Reason for Reject:</strong> {leave.reasonForReject || "N/A"}
//         </p>
//         <p>
  ...
  return (
    <BaseModal isOpen={!!leave} onClose={onClose}>
      <div className="bg-white dark:bg-gray-800 p-6 rounded-md w-11/12 md:w-1/2 relative">
        ...
        <p><strong>From:</strong> {new Date(leave.leave_From).toLocaleDateString()}</p>
        <p><strong>To:</strong> {new Date(leave.leave_To).toLocaleDateString()}</p>
