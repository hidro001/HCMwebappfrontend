...
//   // Complete export data mapping with all original fields
//   const exportData = paginatedData.map((entry, index) => {
//     const serialNo = (currentPage - 1) * pageSize + (index + 1);
//     return {
//       sl: serialNo,
...
//   // Complete columns with all original fields
//   const columns = [
...
//     { header: "Reason for Leave", dataKey: "reason_For_Leave", sortable: false },
//     { header: "Leave Category", dataKey: "is_Paid", sortable: true },
//     { header: "Processed By", dataKey: "processedBy", sortable: false },
//     { header: "Reason For Reject", dataKey: "reason_For_Reject", sortable: false },
//     { header: "Emergency Contact", dataKey: "emergencyContact", sortable: false },
//     { header: "Work Handover", dataKey: "workHandover", sortable: false },
...
//   // Enhanced card view for mobile with all data
...
//               {entry.reason_For_Leave.length > 100 
//                 ? entry.reason_For_Leave.substring(0, 100) + "..."
//                 : entry.reason_For_Leave}
//             </p>
//           </div>
//         )}
...
//                 <p className="text-xs text-gray-700 dark:text-gray-300">{entry.emergencyContact}</p>
//               </div>
//             </div>
//           )}
...
//                 <p className="text-xs text-gray-700 dark:text-gray-300">Yes</p>
//               </div>
//             </div>
//           )}
//         </div>
...
//         {entry.reason_For_Reject && (
//           <div className="pt-2 border-t border-red-200 dark:border-red-700 bg-red-50 dark:bg-red-900/10 -mx-6 -mb-6 px-6 pb-6 mt-4 rounded-b-xl">
//             <p className="text-xs text-red-600 dark:text-red-400 mb-1">Rejection Reason</p>
//             <p className="text-sm text-red-700 dark:text-red-300">{entry.reason_For_Reject}</p>
//           </div>
//         )}
//       </div>
//     </motion.div>
...
//                         </td>
//                         <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
//                           {entry.emergencyContact || "N/A"}
//                         </td>
//                         <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
//                           {entry.workHandover || "N/A"}
//                         </td>
//                         <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
...
//   // Essential columns for table view (detailed fields moved to modal)
//   const columns = [
//     { header: "S.L", dataKey: "sl", sortable: false },
//     { header: "Leave Type", dataKey: "leaveType", sortable: true },
//     { header: "From", dataKey: "leave_From", sortable: true },
...
//   // Simplified card view for mobile - detailed info shown in modal
//   const LeaveCard = ({ entry, index }) => (
//     <motion.div
//       variants={itemVariants}
//       onClick={() => setSelectedLeave(entry)}
...
// // Custom Modern Month Picker Component
