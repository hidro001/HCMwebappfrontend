// src/components/CreateCommentModal.js
...
import useNotificationStore  from '../../store/notificationStore'; // Assuming similar to useAuthStore
...
const CreateCommentModal = ({ open, handleClose, postId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optionally, fetch updated comments or rely on real-time updates
      setComment('');
      setAttachments([]);
      handleClose();
      addNotification({
