...
<Box className="">
  {announcementsLoading ? (
    ...
    >
      {/** 
       * NOTE: We still use a Grid, but each item is xs={12} 
       * so each announcement is one "row." 
       */}
      <Grid container spacing={2} className="">
        {filteredAnnouncements.slice(0, visibleCount).map((announcement) => (
          <Grid item xs={12} key={announcement._id} className="">
          ...
          // className="border border-green-900"
            ...
            >
              ...
              <Box
                ...
                onClick={(e) => e.stopPropagation()} // so clicks on buttons don't open the dialog
              >
                <AnimatedButton
                  variant="contained"
                  startIcon={<FaEdit />}
