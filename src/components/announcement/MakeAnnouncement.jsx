...
//       return announcement.publish_for_all
//         ? true
//         : announcement.department.some(
//             (dept) => dept.department === filterDepartment
//           );
//     })
//     .sort((a, b) => {
//       if (sortOrder === "Newest") {
...
//           <Typography className="text-center">No announcements found.</Typography>
//         ) : (
//           <InfiniteScroll
...
const MakeAnnouncement = () => {
  ...
  const filteredAnnouncements = announcements
    .filter((announcement) => {
      ...
      // Include announcements published for all departments
      // OR announcements specifically for the selected department
      return (
        announcement.publish_for_all ||
        (announcement.department &&
          announcement.department.some(
