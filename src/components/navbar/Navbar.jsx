    ...
    return (
      <div className="relative">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onClick}
          className={`p-2.5 rounded-full bg-transparent ${currentColor.hover} backdrop-blur-sm ${currentColor.text} transition-all duration-300 ease-in-out relative group border border-gray-200/20 dark:border-gray-700/30`}
          aria-label={tooltip}
        >
          {icon}
          {tooltip && (
