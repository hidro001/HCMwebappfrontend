...
// src/components/modal/KPIDetailModal.jsx
...
//   // We still display the AGGREGATED total score / category in the header area.
//   // Then, if rawRating exists, we show each KPI from rawRating.kpis with type/target/achieved/comment.
//   // Otherwise, show “No KPIs recorded” fallback.

//   // Destructure aggregated summary (for displaying overall total‐score + category):
//   const {
//     summary: { totalScore, percentOfTarget, category },
//   } = selectedPeriod;

//   // rawRating is either a full daily‐rating doc, or null if no daily doc for this period.
//   // rawRating.kpis is an array of objects like:
//   //  {
//   //    kpiName: string,
...
//           {/* --- 2) Overall “Manager Feedback” for that day (if rawRating.comment exists) --- */}
//           {rawRating?.comment && (
//             <motion.div
//               initial={{ opacity: 0, y: 10 }}
//               animate={{ opacity: 1, y: 0 }}
...
//               </h4>
//               <span className="text-xs font-medium text-gray-600 dark:text-gray-400 bg-gray-200 dark:bg-gray-700 px-3 py-1.5 rounded-md">
//                 {/* If rawRating exists, show how many KPIs that day. Otherwise show “0 KPIs.” */}
//                 {rawRating?.kpis?.length || 0} KPIs
//               </span>
//             </div>

//             {!rawRating?.kpis || rawRating.kpis.length === 0 ? (
//               <div className="flex items-center justify-center p-8 text-gray-500 dark:text-gray-400 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
//                 <p>No KPIs recorded for this period.</p>
//               </div>
//             ) : (
...
//   // Determine if rawRating is an array of aggregated‐perKpi (weekly mode):
//   const isWeeklyAggregated =
//     Array.isArray(rawRating) &&
//     rawRating.every(
//       (k) => k.kpiName && (k.targetSum !== undefined || k.marksSum !== undefined)
//     );

//   // Determine if rawRating is a single daily doc:
//   //  { date, comment, kpis: [ { kpiName, type, target?, achieved?, score, marks, comment? }, … ] }
...
//               </div>
//             ) : (
//               /* ――― Non-weekly (daily/monthly/etc) case ――― */
//               <>
...
//   // If rawRating is an array of aggregated per‐KPI entries (any aggregated mode: weekly, monthly, yearly, etc.)
...
//   // If rawRating is a single daily document (date + kpis array)
//   const isDailyDoc = rawRating && rawRating.date && rawRating.kpis;
...
//   // Destructure aggregated summary + pull maxScore out of selectedPeriod
//   const {
//     summary: { totalScore, percentOfTarget, category },
//     maxScore,
//   } = selectedPeriod;

//   // If rawRating is an array of aggregated per‐KPI entries
//   const isAggregatedMode =
//     Array.isArray(rawRating) &&
//     rawRating.every(
//       (k) =>
//         k.kpiName && (k.targetSum !== undefined || k.marksSum !== undefined)
//     );
