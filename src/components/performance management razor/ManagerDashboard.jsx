  ...
  <div className={`mb-3 ${className}`}>
    ...
    <div className="relative">
      ...
      <select
        ...
        className={`w-full ${
          icon ? "pl-10" : "pl-3"
        } pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${
          disabled
...
const DateInput = ({ label, value, onChange, className = "" }) => (
  <div className={`mb-3 ${className}`}>
    ...
    <div className="relative">
      ...
      <input
        type="date"
        className="w-full pl-10 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-600"
        value={value}
        onChange={onChange}
      />
    </div>
  ...
  <div className={`mb-3 ${className}`}>
    ...
    <div className="relative">
      ...
      <input
        ...
        className={`w-full ${
          icon ? "pl-10" : "pl-3"
        } pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-600`}
        value={value}
        onChange={onChange}
      />
    </div>
