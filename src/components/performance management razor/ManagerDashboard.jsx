...
//   /* recompute week dropdowns whenever month/year changes */
//   useEffect(() => {
...
//     try {
//       const res = await getManagerTeamAggregated(params); // store call
//       if (res.success) setAnalyticsData(res.data);
//     } catch {
//       /* error surfaced via store’s `error` */
//     }
//   };
