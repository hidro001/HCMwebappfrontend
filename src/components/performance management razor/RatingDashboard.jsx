...
import BulkUploadPast from "./BulkUploadPast"; // Import the new component
import { FiUsers, FiDatabase, FiStar } from "react-icons/fi";
      ...
      <div className="mx-auto px-2 py-2">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-full shadow-md p-1.5 inline-flex">
            ...
            {/* New Bulk Upload Past tab */}
            <button
              onClick={() => setActiveTab("bulkPast")}
              className={`flex items-center justify-center space-x-2 px-6 py-2.5 rounded-full transition-all ${
                activeTab === "bulkPast"
                  ? "bg-indigo-600 text-white shadow-md"
                  : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
        ...
        <div className="transition-all duration-300">
          ...
          {activeTab === "bulkPast" && <BulkUploadPast />}
        </div>
      </div>
    </div>
  );
