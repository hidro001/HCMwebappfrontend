...
// };
// const iconVariants = { hover:{ rotate:360, scale:1.1, transition:{duration:0.3} } };
...
//         <motion.div variants={iconVariants} whileHover="hover" className="p-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg">
//           <Icon className="w-5 h-5 text-white" />
//         </motion.div>
//         <h4 className="font-semibold">{title}</h4>
//       </div>
//       <button onClick={onToggle} className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-200">
...
//   // destructure everything coming from your store
//   const {
//     chart        = [],
//     rawRatings   = [],
//     categories   = [],
...
//   // derived data for movingAverage & periodChange vs period labels
...
//   // summary stats
//   const totalScore = chart.reduce((sum,c)=> sum + (c.totalScore||0), 0);
//   const avgPerf   = chart.length
//     ? Math.round(chart.reduce((sum,c)=> sum + (c.percentOfTarget||0), 0) / chart.length)
//     : 0;
//   const best = chart.reduce((b,c)=> (c.percentOfTarget > (b.percentOfTarget||0)? c: b), {}) || {};
...
//         <ChartCard
//           title="Score & % of Target Over Time"
//           icon={BiLineChart}
...
//                 <Legend/>
//                 <Line yAxisId="left" dataKey="totalScore" name="Total Score" stroke={COLORS[0]} dot/>
//                 <Line yAxisId="right" dataKey="percentOfTarget" name="% of Target" stroke={COLORS[1]} dot unit="%" />
//               </LineChart>
//             </ResponsiveContainer>
//           )}
//         </ChartCard>
...
//                 <Tooltip content={<CustomTooltip/>}/>
//                 <Area type="monotone" dataKey="normalizedScore" name="Normalized Score" stroke={COLORS[1]} fill="url(#perfGrad)"/>
//               </AreaChart>
//             </ResponsiveContainer>
//           )}
//         </ChartCard>
...
//                   <LabelList dataKey="avgPercent" position="right" formatter={v=>`${v}%`}/>
//                 </Bar>
//               </BarChart>
//             </ResponsiveContainer>
//           )}
...
//           ) : (
//             <ResponsiveContainer>
//               <BarChart data={avgDailyKpi.map(k=>({
//                 kpiName: k.kpiName,
//                 avgDailyScore: Math.round(k.avgDailyScore*10)/10
//               }))}>
//                 <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB"/>
//                 <XAxis dataKey="kpiName" angle={-45} textAnchor="end" height={80}/>
//                 <YAxis/>
//                 <Tooltip content={<CustomTooltip/>}/>
...
//                   <LabelList dataKey="periodChange" position="top" formatter={v=>v!=null? `${v}%` : ""}/>
//                 </Bar>
//               </BarChart>
//             </ResponsiveContainer>
//           )}
...
//       {/* ── Tables: Employees, Top/Bottom Performers ───────────── */}
//       <div className="space-y-8">
//         {/* Employee aggregates */}
...
//                 <th className="px-4 py-2 text-right text-sm font-medium">Avg Rating</th>
...
//       {/* ── Heatmap ────────────────────────────────────────────── */}
//       <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg overflow-auto">
//         <h3 className="text-lg font-semibold mb-4">Heatmap (Normalized Scores)</h3>
//         <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
//           <thead>
//             <tr className="bg-gray-50 dark:bg-gray-700">
//               <th className="px-3 py-2 text-left">Employee</th>
//               {chart.map((c,i)=>(
//                 <th key={i} className="px-3 py-2 text-center">{c.period}</th>
//               ))}
//             </tr>
//           </thead>
//           <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
...
//   // build moving‐avg + change series
//   const mvData = useMemo(
//     () =>
//       chart.map((c, i) => ({
//         period: c.period,
...
//   // collect buckets with periods
//   const bucketsWithPeriods = useMemo(() => {
//     const b = Array.from({ length: 10 }).map((_, i) => ({
//       range: `${i * 10}–${i * 10 + 10}%`,
//       count: 0,
//       periods: [],
//     }));
//     chart.forEach((d) => {
//       const idx = Math.min(Math.floor(d.normalizedScore / 10), 9);
//       b[idx].count += 1;
...
//     chart.reduce(
//       (b, c) =>
//         c.percentOfTarget > (b.percentOfTarget || 0) ? c : b,
//       {}
//     ) || {};
