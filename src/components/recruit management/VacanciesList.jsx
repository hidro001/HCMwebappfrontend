...
//       // e.g. "Open", "Closed", "Draft" or whatever your data has
...
//         // set time to 0 so we only compare date
...
//           {/* Status => your data might be "Draft", "Open", "Closed" */}
//           <select
//             className="border rounded px-2 py-1 text-sm bg-white dark:bg-gray-700 dark:text-gray-100"
//             value={status}
//             onChange={(e) => {
...
//                         <td className="p-3 text-sm">{vac.createdBy.first_Name+last_name (employee_Id)}</td>
