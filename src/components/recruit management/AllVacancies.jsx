...
//                 <>
//                   {/* Table View */}
//                   <div className={`${viewMode === "cards" ? "hidden lg:hidden" : "block"} bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden`}>
...
//                   {/* Cards View */}
//                   <div className={`${viewMode === "table" ? "hidden lg:block" : "block"} space-y-4`}>
//                     <AnimatePresence>
//                       {filteredVacancies.map((vacancy, idx) => {
//                         const statusConfig = getStatusConfig(vacancy.status);
//                         return (
...
//           <div className="flex items-center space-x-3">
//             <div className="p-3 bg-blue-100 dark:bg-blue-900/20 rounded-xl">
//               <HiOfficeBuilding className="text-2xl text-blue-600 dark:text-blue-400" />
//             </div>
//             <div>
//               <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">Job Vacancies</h1>
//               <p className="text-gray-600 dark:text-gray-400">Manage and browse available positions</p>
//             </div>
//           </div>
...
//         {/* Error */}
//         {error && (
//           <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6 text-center">
//             <p className="text-red-600 dark:text-red-400 font-medium">{error}</p>
//           </motion.div>
//         )}
...
//                     {/* …copy your existing table JSX exactly here… */}
//                   </div>

//                   {/* CARDS VIEW */}
//                   <div className={viewMode === "cards" ? "block" : "hidden"}>  
//                     {/* …copy your existing cards JSX exactly here… */}
//                   </div>
//                 </>
//               )}
//             </motion.div>
...
//                   <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={handleClearAll} className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
//                     Clear All
//                   </motion.button>
//                 </div>
//                 <FilterPanel filters={filters} handleFilterClick={handleFilterClick} handleClearAll={handleClearAll} />
//               </div>
//             </div>
//           </div>
//         )}
...
//         {isFilterOpen && (
//           <>
//             <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black bg-opacity-50 z-40 2xl:hidden" onClick={() => setIsFilterOpen(false)} />
//             <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "spring", damping: 25, stiffness: 200 }} className="fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 z-50 2xl:hidden">
//               <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
//                 <h2 className="text-lg font-bold text-gray-900 dark:text- 怎么办" />
//                 <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} onClick={() => setIsFilterOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200">
//                   <HiX className="h-5 w-5 text-gray-600 dark:text-gray-400" />
//                 </motion.button>
//               </div>
//               <div className="p-6 overflow-y-auto h-[calc(100vh-80px)]">
...
//       {/* Modals */}
//       <ReferralModal isOpen={isReferModalOpen} onClose={handleCloseReferModal} vacancy={selectedVacancy} />
//       <JobDetailsModal isOpen={isDetailsModalOpen} onClose={handleCloseDetailsModal} vacancy={selectedVacancy} />
//     </motion.div>
//   );
// }
...
export default function AllVacancies() {
  ...
  const [vacanciesData, setVacanciesData] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  const [viewMode, setViewMode] = useState("cards"); // cards or table - default to cards for mobile-first
