...
// export default function RateModal({ show, onClose, onSubmit, selectedMember }) {
//   const handleSubmit = () => {
//     onSubmit();
//     onClose();
//   };
...
//               Rate {selectedMember?.name ?? "Employee"}
//             </h3>
...
//                   KPI Name 1
//                 </label>
//                 <select className="w-full p-2 border rounded dark:border-gray-700 dark:bg-gray-700 dark:text-gray-100">
...
//               {/* Comment */}
//               <div>
//                 <label className="block mb-1 dark:text-gray-100">Comment</label>
//                 <textarea
