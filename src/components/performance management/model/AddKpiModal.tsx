...
//   isOpen: boolean;
//   onClose: () => void;
//   onSave: (kpiName: string, percentage: string) => void;
// }
...
//       {/* 2) Keep your 'card' in a motion.div for scale/fade animations */}
//       <AnimatePresence>
//         {isOpen && (
//           <motion.div
...
//                   id="addKpiName"
//                   type="text"
//                   placeholder="e.g. sales(Indiamart-3/Livekeeping-10)"
...
// src/pages/model/AddKpiModal.jsx
