...
//   isOpen: boolean;
//   onClose: () => void;
//   currentKpi: KpiData | null;
//   onUpdate: (newName: string, newPercentage: string) => void;
// }
...
//   useEffect(() => {
//     // Load existing values into local state when the modal is opened
//     if (isOpen && currentKpi) {
//       setName(currentKpi.name);
//       setPercentage(currentKpi.percentage);
//     }
//   }, [isOpen, currentKpi]);
...
//               <div>
//                 <label
//                   htmlFor="editKpiPercentage"
//                   className="block text-sm font-medium text-gray-700 dark:text-gray-200"
//                 >
//                   Percentage (%)
//                 </label>
//                 <input
//                   id="editKpiPercentage"
//                   type="text"
//                   className="mt-1 block w-full border border-gray-300 
//                              rounded-md p-2 dark:bg-gray-700 dark:border-gray-600 
//                              dark:text-gray-100 focus:outline-none 
...
// src/pages/model/EditKpiModal.jsx
