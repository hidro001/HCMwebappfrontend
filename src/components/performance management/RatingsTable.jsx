...
//       {loading ? (
//         <p className="text-center">Loading ratings...</p>
//       ) : data && data.length > 0 ? (
...
//                 <th className="p-2">Rated By</th>
//                 <th className="p-2">Submitted On</th>
//                 <th className="p-2">For YY/MM</th>
...
//                   <td className="p-2">{item.ratedTo?.employee_Id}</td>
//                   <td className="p-2">
//                     {item.ratedTo?.first_Name} {item.ratedTo?.last_Name}
//                   </td>
//                   <td className="p-2">{item.ratedTo?.designation}</td>
//                   <td className="p-2">{item.averageRating}</td>
//                   <td className="p-2">{item.comments || "N/A"}</td>
//                   <td className="p-2">
