...
function Chatsv2() {
  ...
  return (
    <div className="container mx-auto p-2 sm:p-4">
      <div className="inner-section flex rounded-2xl bg-white dark:bg-gray-900 shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        {/* Sidebar */}
        ...
        {/* Main Chat Section */}
        <section className="conversation w-full bg-gray-50 dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700">
          <div className="overflow-hidden h-screen">
            <ChatWindow />
          </div>
        </section>
