...
//       {/* Main container with uniform spacing from all edges (m-4) */}
//       <div className="relative z-50 w-full max-w-6xl max-h-[90vh] m-4 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
        
//         {/* Modal Header */}
//         <div className="flex items-center justify-between p-6 lg:p-8 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-gray-800/50 dark:to-gray-700/50">
...
//                 Task Details
//               </h2>
//               <p className="text-gray-600 dark:text-gray-400 text-sm">View and manage task information</p>
//             </div>
//           </div>
...
//                           <FaIdCard className="text-blue-600 dark:text-blue-400 text-sm" />
//                         </div>
...
//                       value={status}
//                       onChange={handleStatusChange}
//                       className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
//                     >
//                       <option value="Not Started">Not Started</option>
//                       <option value="In Progress">In Progress</option>
//                       <option value="Completed">Completed</option>
...
const AssignedTaskModal = ({ task, onClose }) => {
  ...
  return (
    <BaseModal isOpen={!!task} onClose={onClose}>
      <div className="w-full max-w-6xl max-h-[90vh] m-4 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
