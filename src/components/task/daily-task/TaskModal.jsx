      ...
      {isOpen && (
        <BaseModal isOpen={isOpen} onClose={onClose}>
          ...
          >
            ...
            >
              <div
                className="flex-1 overflow-y-auto p-8 space-y-8 bg-gradient-to-br from-gray-50/80 via-white to-indigo-50/30 dark:from-gray-800/80 dark:via-gray-800 dark:to-indigo-900/20
