  ...
  return (
    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 animate-fade-in">
      ...
      <ConfirmationDialog
        ...
        title="Delete Task"
        message={`Are you sure you want to delete this task${taskToDelete?.task?.length > 1 ? ` with ${taskToDelete.task.length} items` : ''}? This action cannot be undone.`}
        ...
        type="danger"
        destructive={true}
        loading={loadingId === taskToDelete?._id}
        icon={FiTrash2}
      />
    </div>
  );
