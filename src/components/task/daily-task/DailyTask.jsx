...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-950 text-gray-800 dark:text-gray-100 transition-all duration-300 ease-in-out">
//       {/* Futuristic top header with glassmorphism */}
//       <div className="bg-white bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-80 backdrop-filter backdrop-blur-lg border-b border-blue-100 dark:border-indigo-900 sticky top-0 z-10 shadow-lg">
...
//               </div>
//               <h1 className="text-2xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-300 bg-clip-text text-transparent">
...
//         {/* Add/Edit Task Card */}
//         <div className="mb-12 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl border border-blue-100 dark:border-indigo-900 transform transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]">
...
//               ) : (
//                 <>
//                   <FiPlus className="mr-2" /> Add New Tasks
//                 </>
//               )}
//             </h2>
//           </div>
...
//                   className="relative bg-gray-50 dark:bg-gray-750 rounded-xl p-4 border border-gray-200 dark:border-gray-700 group"
//                 >
//                   <div className="flex items-center mb-2">
//                     <div className="h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-300 mr-2">
//                       {index + 1}
//                     </div>
//                     <label
//                       htmlFor={`task-${index}`}
...
//                     rows={2}
//                     className="block w-full rounded-xl bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 p-3 text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-600 dark:focus:border-blue-500 resize-none shadow-sm transition-all duration-200"
//                   />
//                 </motion.div>
//               ))}
//             </AnimatePresence>
...
//                 type="button"
//                 onClick={handleAddTaskInput}
//                 className="flex items-center px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
//               >
...
//                   type="button"
//                   onClick={handleCancelEdit}
//                   className="flex items-center px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
//                 >
...
//                 type="submit"
//                 disabled={loading}
//                 className="flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-70 disabled:cursor-not-allowed"
//               >
//                 {loading ? (
...
//                 )}
//                 {editMode ? "Update Task" : "Submit Tasks"}
//               </button>
//             </div>
//           </form>
//         </div>
...
//         <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl border border-blue-100 dark:border-indigo-900">
//           <div className="bg-gradient-to-r from-indigo-500 to-purple-600 py-4 px-6 flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
//             <h2 className="text-xl font-bold text-white flex items-center">
//               <FiList className="mr-2" /> Your Tasks
//             </h2>

//             {/* Date Filter */}
//             <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg p-1 backdrop-filter backdrop-blur-md">
//               <label htmlFor="filterDate" className="text-white text-sm flex items-center px-2">
//                 <FiCalendar className="mr-1" /> Filter
//               </label>
//               <input
//                 type="date"
//                 id="filterDate"
//                 value={filterDate}
//                 onChange={(e) => setFilterDate(e.target.value)}
//                 className="bg-white bg-opacity-90 dark:bg-gray-800 border-0 rounded-lg p-1 text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-white"
//               />
//               {filterDate && (
//                 <button
//                   type="button"
//                   onClick={() => setFilterDate("")}
//                   className="text-white hover:text-red-200 p-1 rounded-full hover:bg-white hover:bg-opacity-20 transition-colors"
//                   title="Clear filter"
//                 >
//                   <FiX />
//                 </button>
...
//                               className="hover:bg-blue-50 dark:hover:bg-indigo-900/20 transition-colors"
//                             >
//                               <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
//                                 <span className="flex items-center justify-center h-7 w-7 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300">
//                                   {index + 1 + startIndex}
//                                 </span>
//                               </td>
...
//                                       >
//                                         <span className="h-5 w-5 mr-2 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-xs text-blue-600 dark:text-blue-300 shrink-0 mt-0.5">
//                                           {idx + 1}
//                                         </span>
//                                         <span>{t}</span>
//                                       </div>
...
//                                     <FiCalendar className="mr-1 text-blue-500 dark:text-blue-400" />
//                                     {item.task_Date}
//                                   </div>
//                                 ) : (
//                                   <span className="text-gray-400 dark:text-gray-500 italic flex items-center">
//                                     <FiAlertCircle className="mr-1" /> No date set
//                                   </span>
//                                 )}
//                               </td>
...
//                                   <button
//                                     type="button"
//                                     className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
//                                     onClick={() => handleUpdateClick(item)}
//                                   >
...
//                                     className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50"
//                                     onClick={() => handleDeleteTask(item._id)}
//                                   >
//                                     {loadingId === item._id ? (
...
//                       <div className="h-24 w-24 rounded-full bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-blue-500 dark:text-blue-400 mb-4">
//                         <FiList className="h-12 w-12" />
//                       </div>
//                       <h3 className="text-xl font-medium text-gray-600 dark:text-gray-300 mb-1">No tasks found</h3>
//                       <p className="text-gray-500 dark:text-gray-400">
//                         {filterDate ? "Try a different date filter or " : ""}
...
//                     </span>{" "}
//                     of <span className="font-medium text-gray-700 dark:text-gray-300">{totalItems}</span> tasks
//                   </div>
...
//                           if (e.key === "Enter") goToPage(Number(manualPage));
//                         }}
//                         className="w-12 text-center border-none py-1.5 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"
//                       />
...
//   return (
//     <div className="  dark:bg-gray-950 text-gray-800 dark:text-gray-100 transition-all duration-300 ease-in-out">
//       {/* Futuristic top header with glassmorphism */}
//       <div className="bg-white bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-80 backdrop-filter backdrop-blur-lg border-b border-blue-100 dark:border-indigo-900 sticky top-0 z-10 shadow-lg">
//         <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
//           <div className="flex items-center justify-between">
...
//                 type="button"
//                 onClick={handleAddTaskInput}
//                 className="flex items-center px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
//               >
//                 <FiPlus className="mr-1" /> Add Field
//               </button>
...
//                   type="button"
//                   onClick={handleCancelEdit}
//                   className="flex items-center px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
//                 >
//                   <FiX className="mr-1" /> Cancel
//                 </button>
//               )}
...
//             {/* Date Filter */}
//             <div className="flex items-center space-x-2 bg-white bg-opacity-20 dark:bg-gray-700 dark:bg-opacity-70 rounded-lg p-1 backdrop-filter backdrop-blur-md">
//               <label htmlFor="filterDate" className="text-white text-sm flex items-center px-2">
//                 <FiCalendar className="mr-1" /> Filter
//               </label>
//               <input
...
//     <div className="dark:bg-gray-950 text-gray-800 dark:text-gray-100 transition-all duration-300 ease-in-out">
//       {/* Futuristic top header with glassmorphism */}
//       <div className="bg-white bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-80 backdrop-filter backdrop-blur-lg border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10 shadow-lg">
//         <div className=" mx-auto py-6 px-4 sm:px-6 lg:px-8">
//           <div className="flex items-center justify-between">
//             <div className="flex items-center space-x-3">
//               <div className="bg-teal-500 rounded-lg p-2 shadow-lg">
//                 <FiList className="h-6 w-6 text-white" />
//               </div>
//               <h1 className="text-2xl font-extrabold bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-400 dark:to-cyan-400 bg-clip-text text-transparent">
//                 Daily Task Management
//               </h1>
//             </div>
//             <button
//               onClick={fetchTasks}
//               className="flex items-center space-x-1 text-teal-600 dark:text-teal-400 hover:text-teal-800 dark:hover:text-teal-300 transition-colors"
//             >
//               <FiRefreshCw className={`h-4 w-4 ${loading ? 'animate-spin' : ''}`} />
//               <span className="text-sm">Refresh</span>
//             </button>
...
//         {/* Add/Edit Task Card */}
//         <div className="mb-12 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-700 transform transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]">
...
//                 >
//                   <div className="flex items-center mb-2">
//                     <div className="h-6 w-6 rounded-full bg-emerald-100 dark:bg-emerald-900 flex items-center justify-center text-emerald-600 dark:text-emerald-300 mr-2">
//                       {index + 1}
//                     </div>
//                     <label
//                       htmlFor={`task-${index}`}
...
//                     placeholder="What needs to be done?"
//                     rows={2}
//                     className="block w-full rounded-xl bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 p-3 text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:focus:ring-emerald-600 dark:focus:border-emerald-500 resize-none shadow-sm transition-all duration-200"
//                   />
//                 </motion.div>
//               ))}
//             </AnimatePresence>
...
//                 type="button"
//                 onClick={handleAddTaskInput}
//                 className="flex items-center px-4 py-2 rounded-full bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
//               >
//                 <FiPlus className="mr-1" /> Add Field
//               </button>
...
//                 type="submit"
//                 disabled={loading}
//                 className="flex items-center px-6 py-2 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-70 disabled:cursor-not-allowed"
//               >
//                 {loading ? (
//                   <FiRefreshCw className="animate-spin mr-2" />
//                 ) : editMode ? (
...
//         {/* Tasks List with Filter */}
//         <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-700">
//           <div className="bg-violet-600 py-4 px-6 flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
//             <h2 className="text-xl font-bold text-white flex items-center">
//               <FiList className="mr-2" /> Your Tasks
//             </h2>
...
//                             >
//                               <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
//                                 <span className="flex items-center justify-center h-7 w-7 rounded-full bg-violet-100 dark:bg-violet-900 text-violet-600 dark:text-violet-300">
//                                   {index + 1 + startIndex}
//                                 </span>
//                               </td>
//                               <td className="px-6 py-4">
...
//                                         className="flex items-start text-sm text-gray-700 dark:text-gray-300"
//                                       >
//                                         <span className="h-5 w-5 mr-2 rounded-full bg-violet-100 dark:bg-violet-900 flex items-center justify-center text-xs text-violet-600 dark:text-violet-300 shrink-0 mt-0.5">
//                                           {idx + 1}
//                                         </span>
//                                         <span>{t}</span>
//                                       </div>
...
//                                 {item.task_Date ? (
//                                   <div className="flex items-center">
//                                     <FiCalendar className="mr-1 text-violet-500 dark:text-violet-400" />
//                                     {item.task_Date}
//                                   </div>
//                                 ) : (
//                                   <span className="text-gray-400 dark:text-gray-500 italic flex items-center">
...
//                                   <button
//                                     type="button"
//                                     className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
//                                     onClick={() => handleUpdateClick(item)}
//                                   >
//                                     <FiEdit2 className="mr-1" /> Edit
//                                   </button>
...
//                   ) : (
//                     <div className="py-20 flex flex-col items-center">
//                       <div className="h-24 w-24 rounded-full bg-violet-50 dark:bg-violet-900/30 flex items-center justify-center text-violet-500 dark:text-violet-400 mb-4">
//                         <FiList className="h-12 w-12" />
//                       </div>
//                       <h3 className="text-xl font-medium text-gray-600 dark:text-gray-300 mb-1">No tasks found</h3>
//                       <p className="text-gray-500 dark:text-gray-400">
...
//                           if (e.key === "Enter") goToPage(Number(manualPage));
//                         }}
//                         className="w-12 text-center border-none py-1.5 focus:ring-violet-500 focus:border-violet-500 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"
//                       />
//                       <span className="bg-gray-100 dark:bg-gray-700 px-2 py-1.5 text-gray-500 dark:text-gray-400 text-sm">
//                         / {totalPages}
//                       </span>
